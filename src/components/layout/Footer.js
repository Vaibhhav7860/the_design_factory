      ...
      <div className={styles.grid}>
        ...
        <div className={styles.col}>
          ...
          <div className={styles.newsletterInput}>
            ...
            />
            <button aria-label="Subscribe" suppressHydrationWarning>
          ...
          <div className={`${styles.socialIcons} ${styles.socialIconsMobileOnly}`}>
            {/* Instagram */}
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="url(#ig-gradient-mobile)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <defs>
                  <linearGradient id="ig-gradient-mobile" x1="0%" y1="100%" x2="100%" y2="0%">
                    <stop offset="0%" stopColor="#f09433" />
                    <stop offset="25%" stopColor="#e6683c" />
                    <stop offset="50%" stopColor="#dc2743" />
                    <stop offset="75%" stopColor="#cc2366" />
